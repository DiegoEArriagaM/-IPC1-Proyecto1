...
public class ModuloProfesores {
    ...
    void ventana(){
        //Pantalla de Inicio
        frameprincipal=new JFrame("Modulo de Profesores");
        ...
        while(a<datos.cantCur){
            ...
            if(datos.usuario==datos.codigoPC[a]){
                //Se establecen las características del boton
                botonCurso[a]=new JButton(datos.nombreC[a]);
                ...
                labelCurso[a]= new JLabel(datos.alumnosC[a]+" Alumnos",SwingConstants.RIGHT);
    ...
    void actualizar(){
        ...
        while(a<datos.cantPro){
            if(datos.usuario==datos.codigoP[a]){break;}
            a++;
        }
